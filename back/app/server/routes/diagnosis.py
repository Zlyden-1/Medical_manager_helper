...
async def download_report(filename: str) -> FileResponse:
    # return FileResponse(f'../media/test_1.docx', media_type='multipart/form-data')
    return FileResponse(os.path.abspath(f'{os.path.dirname(os.path.dirname(os.path.abspath(__file__)))}/media/{filename}'), media_type='multipart/form-data')
